...
class Controller:
    ...
    def __init__(self, game):
        ...
        self.num_floors = game.get_num_floors()
        self.all_floors  = tuple(range(self.num_floors))
        self.horizon     = game.get_horizon()
        ...
        for (eid, floor, wload) in elevators_t0:
            ...
            self.elev_capacity[eid]   = game.get_elevator_capacity(eid)
        ...
        for (pid, loc) in persons_t0:
            ...
            dest = game.get_person_destination(pid)
        ...
        for eid in self.eids:
            ...
            for fa in self.all_floors:
                ...
                for fb in self.all_floors:
                    row[fa][fb] = 0.0 if fa == fb else inv_pe
            self.E_move[eid] = row
    ...
    def choose_action(self, state):
        ...
        steps_left = self.game.get_steps_remaining()
